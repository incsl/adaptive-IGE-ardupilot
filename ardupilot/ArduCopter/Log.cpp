...
void Copter::Log_Write_Control_Tuning()
{
    ...
    // error_alt = des_alt_m - inertial_nav.get_altitude() / 100.0f;
    ...
    struct log_Control_Tuning pkt = {
        ...
        throttle_in         : pos_control->get_vz_dot(),//error_alt,
        angle_boost         : pos_control->get_h(),
        throttle_out        : pos_control->get_rho_hat(),
        throttle_hover      : pos_control->get_real_alt(),
