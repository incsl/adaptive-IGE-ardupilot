...
#define Ix 2.023e-3f
#define Iy 1.6867e-3f
#define Iz 2.6609e-3f
#define Roll_coef  0.0528f//0.48f*0.11f
#define Pitch_coef 0.0432f//0.46*0.09
...
void AC_AttitudeControl_Multi::rate_controller_run()
{
    ...
    // float z_hat1 = 0.0f;
    // float z_hat2 = 0.0f;
    // float p1 = 2.0f*gyro_latest.x;
    // float p2 = 2.0f*(gyro_latest.x + gyro_latest.y);
    // float temp1 = 0.0f;
    // float temp2 = 0.0f;
    // // const float compensation_gain = multi_motor->get_comp_gain();

    // temp1 = (Iz - Iy - Ix)*gyro_latest.z*gyro_latest.y -_z1 - _motors.get_roll()*Roll_coef/safe_sqrt(2.0f) - p1;
    // temp2 = (Iy + Ix - Iz)*gyro_latest.z*gyro_latest.x -_z2 - _motors.get_pitch()*Pitch_coef/safe_sqrt(2.0f) - p2;
    // z_hat1 = temp1/Ix;
    // z_hat2 = temp1/Ix + temp2/Iy;

    // _z1 = _z1 + z_hat1*0.0025f;
    // _z2 = _z2 + z_hat2*0.0025f;
